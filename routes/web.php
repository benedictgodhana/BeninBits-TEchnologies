...
Route::get('/it-solutions', function () {
    ...
    $clients=Client::all();
    return view('Solutions', compact('products','clients'));
});

Route::get('/it-project-management', function () {

    return view('ProjectManagement');
});

Route::get('/non-it-projects', function () {
    return view('Non-IT_ProjectManagement');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('packages')->name('packages.')->group(function () {
        ...
        Route::get('/it-solutions', [PackageController::class, 'itSolutions'])->name('it_solutions');
        Route::get('/it-projects', [PackageController::class, 'itProjects'])->name('it_projects');
        Route::get('/non-it-projects', [PackageController::class, 'nonItProjects'])->name('non_it_projects');
    });
    //clients
